...
<section class="default-margin hero">
  <div class="hero-text"> 
    ...
    <h4 class="mb-s">Our app offers a beatifully designed, easy-to-use interface that makes managing your book collection a joy</h4>
   <Button href="/register">Sign Up</Button>
  </div>
  <img class="hero-image" src={heroImage} alt="books"/>
